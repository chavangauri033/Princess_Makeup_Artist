...
<h2><font color=black face="Forte" size="7">Manage Batche's</font></h2>

<table align=center class=table border=2px bgcolor=white>
	<thead bgcolor=black>
	<tr>
		<th><font color=white><h3>Batch Id</h3></font></th>	
		<th><font color=white><h3>Course Name</h3></font></th>	
		<th><font color=white><h3>No. Of Student's</h3></font></th>	
		<th><font color=white><h3>Student's Name</h3></font></th>	
		<th><font color=white><h3>Batch Time</h3></font></th>
		<th><font color=white><h3>Batch Date</h3></font></th>
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$txtdt1=$a['Batch_Date'];
		echo "<tr>";
		echo "<td><center><h5>$id</h5></center></td><td><center><h5>$txtcnm</h5></center></td><td><center><h5>$txtns</h5></center></td>
			<td><center><h5>$txtsnm</h5></center></td><td><center><h5>$txtdt</h5></center></td><td><center><h5>$txtdt1</h5></center></td>
			<td><center><a href=delbatch.php?Batch_Id=$id><font color=red><b>Delete</font></a>/<a href=upbatch.php?Batch_Id=$id><font color=blue><b>Update</font></a><center></td>";
		echo "</tr>";
		}
	?>
	</tbody>
