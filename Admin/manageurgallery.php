...
<h2><font color=black face="Forte" size="7">Manage Gallery</font></h2>
...
<table align=center class=table border=2px bgcolor=white>
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$fn=$a['img'];
		echo "<tr>";
		echo "<td><center><h5>$id</h5></center></td><td><center><img src=images/$fn height=120 width=170></center></center></td>
			<td><center><a href=delugl.php?Gallery_Id=$id><font color=red><b>Delete</font></a>/<a href=upugal.php?Gallery_Id=$id><font color=blue><b>Update</font></a><center></td>";
		echo "</tr>";
		}
	?>
	</tbody>
