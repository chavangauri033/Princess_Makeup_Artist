...
<div class="navbar" style="padding:20px">
			...
			<tr>
					...
					<th><li><a href="../alogin.php">Logout</a></li></th>s
		 </tr>
		</table></center>
		</ul> 
...
<h2><font color=black face="Forte" size="7">Manage Student Feedback</font></h2>

<table align=center class=table border=2px bgcolor=white>
	<thead bgcolor=black>
	<tr>
		<th><font color=white><h3>Name</h3></font></th>	
		<th><font color=white><h3>your Email Id</h3></font></th>	
		<th><font color=white><h3>Message</h3></font></th>
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$txtfeed=$a['feedback'];
		echo "<tr>";
		echo "<td><center><h5>$txtnm</h5></center></td><td><center><h5>$txtemail</h5></center></td><td><center><h5>$txtfeed</h5></center></td>
			<td><center><a href=delstufeedback.php?Stu_Fullname=$txtnm><font color=red><b>Delete</font></a>";
		echo "</tr>";
		}
	?>
	</tbody>
