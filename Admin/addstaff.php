...
<td><input type=text name=txtnm id=txtnm style="width:200px;height:25px">
</td>
</tr>
<tr>
<th colspan=2 align=center>
<input type=Submit name=btnsub value=Upload id=btnsub  style="background-color:grey">
</th>
<td></td>
</tr>
</table>
...
<?php
	if(isset($_POST['btnsub']))
	{
		...
		$q="insert into manage_staffgallery(Staff_Id,Staff_img,Staff_name) values('','$fn','$txtnm')";
		mysqli_query($cn,$q);
		mysqli_close($cn);
		echo "<script>alert('Image Added Successfully');window.location='addstaff.php'</script>";
