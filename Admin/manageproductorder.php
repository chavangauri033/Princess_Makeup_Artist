...
<h2><font color=black face="Forte" size="7">Manage Product Orders</font></h2>

<table align=center class=table border=2px bgcolor=white>
	<thead bgcolor=black>
	<tr>
		<th><font color=white><h3>Order Id</h3></font></th>
		<th><font color=white><h3>User Name</h3></font></th>		
		<th><font color=white><h3>Product Id</h3></font></th>	
		<th><font color=white><h3>Product Name</h3></font></th>
		<th><font color=white><h3>Product Quantity</h3></font></th>
		<th><font color=white><h3>Ammount</h3></font></th>
		<th><font color=white><h3>Order Date</h3></font></th>	
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$txtod=$a['Orderdate'];
		echo "<tr>";
		echo "<td><center><h5>$oid</h5></center></td><td><center><h5>$txtuser</h5></center></td><td><center><h5>$id</h5></center></td><td><center><h5>$txtpnm</h5></center></td>
			<td><center><h5>$lstmenu2</h5></center></td><td><center><h5>$amt</h5></center></td><td><center><h5>$txtod</h5></center></td>
			<td><center><a href=delproorder.php?Order_Id=$oid><font color=red><b>Delete</font></a></td>";
		echo "</tr>";
		}
	?>
	</tbody>
