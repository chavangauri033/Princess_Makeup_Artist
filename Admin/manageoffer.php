...
<h2><font color=black face="Forte" size="7">Manage Offers</font></h2>

<table align=center class=table border=2px bgcolor=white>
	<thead bgcolor=black>
	<tr>
		<th><font color=white><h3>Offer Id</h3></font></th>	
		<th><font color=white><h3>Offer Image</h3></font</th>	
		<th><font color=white><h3>Todays offer</h3></font></th>	
		<th><font color=white><h3>Percent</h3></font></th>
	...
	<?php
		...
		echo "<tr>";
		echo "<td><center><h5>$id</h5></center></td><td><center><img src=images/$fn width=100 height=100></center></td><td><center><h5>$txtonm</h5></center></td>
			<td><center><h5>$txtpr</h5></center></td>
			<td><center><a href=deloffer.php?Offer_Id=$id><font color=red><b>Delete</font></a>/<a href=upoffer.php?Offer_Id=$id><font color=blue><b>Update</font></a><center></td>";
		echo "</tr>";
		}
	?>
	</tbody>
