...
<!--==============================Content=================================-->
<center>
	<u><h1 align=center>Daily Report</h1></u>
	<form method=post>
		Select Date<input type=text name=dt id=dt><br><br>
		...
		<tbody bgcolor=pink>
			...
			<?php
				...
				if(isset($_POST['btnsub']))
				{
					...
					$rs=mysqli_query($cn,"select * from product_order where Orderdate=$d");
		...
		<tbody bgcolor=pink>
			...
			<?php
				...
				if(isset($_POST['btnsub']))
				{
					...
					$rs=mysqli_query($cn,"select * from manage_makeuporder where Mcurrent_Date=$d");
		...
		<tbody bgcolor=pink>
			...
			<?php
				...
				if(isset($_POST['btnsub']))
				{
					...
					$rs=mysqli_query($cn,"select * from admission where Admission_date=$m");
