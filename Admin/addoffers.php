...
<tr>
<th align=right>Todays Offer-</th>
<td><input type=text name=txtonm id=txtonm style="width:200px;height:25px">
</td>
</tr>
<tr>
<th align=right>Offers In Percent-</th>
<td><input type=text name=txtpr id=txtpr style="width:200px;height:25px">
</td>
</tr>
...
<?php
	if(isset($_POST['btnsub']))
	{
		...
		$q="insert into manage_offers(Offer_Id,offer_img,Todays_Offer,Percent) values('','$fn','$txtonm','$txtpr')";
		mysqli_query($cn,$q);
		mysqli_close($cn);
		echo "<script>alert('Offer Uploaded Successfully');window.location='addoffers.php'</script>";
