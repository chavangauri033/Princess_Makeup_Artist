...
<td><input type=text name=txtns id=txtns style="width:200px;height:25px">
</td>
</tr>
<tr>
<th align=right>Student's Name-</th>
<td><textarea name=txtsnm id=txtsnm tyle="width:200px;height:25px">
</textarea>
</td>
</tr>
<tr>
<th align=right>Batch Time-</th>
<td><input type=text name="txtdt" id="txtdt" style="width:200px;height:25px">
</td>
</tr>
<tr>
<th align=right>Batch Date-</th>
<td><input type=date name="txtdt1" id="txtdt1" style="width:200px;height:25px">
</td>
</tr>
...
<?php
	if(isset($_POST['btnsub']))
	{
		...
		$q="insert into manage_batch values('','$txtcnm','$txtns','$txtsnm','$txtdt','$txtdt1')";
		mysqli_query($cn,$q);
		mysqli_close($cn);
		echo "<script>alert('Manage Batch Successfully');window.location='addbatches.php'</script>";
	}
