...
<h2><font color=black face="Forte" size="7">Manage Staff Gallery</font></h2>
...
<table align=center class=table border=2px bgcolor=white>
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$txtsnm=$a['Staff_Name'];
		echo "<tr>";
		echo "<td><center><h5>$id</h5></center></td><td><center><img src=images/$fn height=100 width=100></center></td><td><center><h5>$txtsnm</h5></center></td>
			<td><center><a href=delstaff.php?Staff_Id=$id><font color=red><b>Delete</font></a>/<a href=upstaff.php?Staff_Id=$id><font color=blue><b>Update</font></a><center></td>";
		echo "</tr>";
		}
	?>
	</tbody>
