...
<h2><font color=black face="Forte" size="7">Manage User Registration</font></h2>

<table align=center class=table border=2px bgcolor=white>
	<thead bgcolor=black>
	<tr>
		<th><font color=white><h3>Name</h3></font></th>	
		<th><font color=white><h3>Contact No</h3></font></th>	
		<th><font color=white><h3>Email Id</h3></font></th>
		<th><font color=white><h3>Address</h3></font></th>	
		<th><font color=white><h3>Gender</h3></font></th>	
		<th><font color=white><h3>City</h3></font></th>
		<th><font color=white><h3>UserName</h3></font></th>	
		<th><font color=white><h3>Password</h3></font></th>	
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$txtemail=$a['U_Email'];
			$txtadd=$a['U_Address'];
			$txtgender=$a['U_Gender'];
			$txtcity=$a['U_City'];
			$txtuser=$a['User_Name'];
			$txtpass=$a['U_Password'];
			
		echo "<tr>";
		echo "<td><center><h5>$txtnm</h5></center></td>
			<td><center><h5>$txtcon</h5></center></td><td><center><h5>$txtemail</h5></center></td><td><center><h4>$txtadd</h4></center></td><td><center><h4>$txtgender</h4></center></td><td><center><h4>$txtcity</h4></center></td><td><center><h4>$txtuser</h4></center></td><td><center><h4>$txtpass</h4></center></td>";
		echo "</tr>";
		}
	?>
	</tbody>
