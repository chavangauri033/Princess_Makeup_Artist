...
<td><textarea name=txtdis id=txtdis tyle="width:200px;height:25px">
</textarea>
</td>
</tr>
<tr>
<th align=right>Couse Price-</th>
<td><input type=text name=txtcprc id=txtcprc style="width:200px;height:25px">
</td>
</tr>
<tr>
...
<?php
	if(isset($_POST['btnsub']))
	{
		...
		$txtdis=$_POST['txtdis'];
		$txtcprc=$_POST['txtcprc'];
		//end of image uploading
		include("connection.php");
		$q="insert into manage_courses(Course_Id,Course_img,Course_Name,Course_Description,Course_Price) values('','$fn','$lstmenu','$txtdis','$txtcprc')";
		mysqli_query($cn,$q);
		mysqli_close($cn);
		echo "<script>alert('Course Information Uploaded Successfully');window.location='addcourses.php'</script>";
