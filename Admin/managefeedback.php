...
<h2><font color=black face="Forte" size="7">Manage Feedback</font></h2>
...
<table align=center class=table border=2px bgcolor=white>
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$txtfeed=$a['Message'];
		echo "<tr>";
		echo "<td><center><h5>$txtnm</h5></center></td><td><center><h5>$txtem</h5></center></td><td><center><h5>$txtfeed</h5></center></td>
			<td><center><a href=deluserfeedback.php?Fullname=$txtnm><font color=red><b>Delete</font></a>";
		echo "</tr>";
		}
	?>
	</tbody>
