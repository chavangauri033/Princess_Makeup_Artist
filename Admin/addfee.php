...
<td><input type=text name=txtsnm id=txtsnm style="width:200px;height:25px">
</td>
</tr>
<tr>
<th align=right>Courses Name-</th>
<td><input type=text name=txtcnm id=txtcnm style="width:200px;height:25px">
</td>
</tr>
<tr>
<th align=right>Total Fee-</th>
<td><input type=text name=txttfe id=txttfe style="width:200px;height:25px">
</td>
</tr>

<tr>
<th align=right>Paid Fee-</th>
<td><input type=text name=txtpfe id=txtpfe style="width:200px;height:25px">
</td>
</tr>
<tr>
<th align=right>Remaining Fee-</th>
<td><input type=text name=txtrfe id=txtrfe style="width:200px;height:25px">
</td>
</tr>
<tr>
<th colspan=2 align=center>
<input type=Submit name=btnsub value=Add id=btnsub  style="background-color:grey">
</th>
<td></td>
</tr>
</table>
...
<?php
	if(isset($_POST['btnsub']))
	{
		...
		$q="insert into manage_fee values('','$txtsnm','$txtcnm','$txttfe','$txtpfe','$txtrfe')";
		mysqli_query($cn,$q);
		mysqli_close($cn);
		echo "<script>alert('Upload Info Of Fee Successfully');window.location='addfee.php'</script>";
	}
