...
<h2><font color=black face="Forte" size="7">Manage product</font></h2>
...
<table align=center class=table border=2px bgcolor=white>
	...
	<tr>
		...
		<th><font color=white><h3>Product Price</h3></font></th>	
		<th><font color=white><h3>Product Description</h3></font></th>
		<th><font color=white><h3>Product Price</h3></font></th>	
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$fn=$a['Pr_img'];
		echo "<tr>";
		echo "<td><center><h5>$id</h5></center></td><td><center><h5>$txtpnm</h5></center></td><td><center><h5>$txtpprc</h5></center></td><td><center><h5>$txtpdis</h5></center></td>
			<td><center><img src=images/$fn height=100 width=100></center></td>
			<td><center><a href=delpro.php?Pr_Id=$id><font color=red><b>Delete</font></a>/<a href=uppro.php?Pr_Id=$id><font color=blue><b>Update</font></a><center></td>";
		echo "</tr>";
		}
	?>
	</tbody>
