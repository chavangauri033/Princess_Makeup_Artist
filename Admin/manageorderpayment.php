...
<h2><font color=black face="Forte" size="7">Manage Product Order Payment</font></h2>

<table align=center class=table border=2px bgcolor=white>
	<thead bgcolor=black>
	<tr>
		<th><font color=white><h3>Payment Id</h3></font></th>
		<th><font color=white><h3>User Name</h3></font></th>		
		<th><font color=white><h3>Address</h3></font></th>	
		<th><font color=white><h3>Total Amount</h3></font></th>
		<th><font color=white><h3>Payment Mode</h3></font></th>
	...
	<?php
		...
		while($a=mysqli_fetch_array($rs))
		{
			...
			$txtadd=$a['Address'];
			$amt=$a['Tammount'];
			$txtpayment=$a['Payment_Mode'];
		echo "<tr>";
		echo "<td><center><h5>$pid</h5></center></td><td><center><h5>$txtuser</h5></center></td><td><center><h5>$txtadd</h5></center></td><td><center><h5>$amt</h5></center></td>
			<td><center><h5>$txtpayment</h5></center></td><td><center><a href=delpayment.php?Payment_Id=$pid><font color=red><b>Delete</font></a></td>";      
		echo "</tr>";
		}
	?>
	</tbody>
